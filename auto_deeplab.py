...
class AutoDeeplab(nn.Module):
    def __init__(self, num_classes, num_layers, criterion=None, filter_multiplier=8, block_multiplier=5, step=5, cell=cell_level_search.Cell):
        ...
        self.stem0 = nn.Sequential(
            nn.Conv2d(25, half_f_initial * self._block_multiplier, 3, stride=2, padding=1),
        ...
        self.norm_input = SizeNormLayer(mode='pad', divisible_number=2 ** 6)
    ...
    def forward(self, x):
        ...
        return self.recovery_size(sum_feature_map, self.norm_input.padding)
